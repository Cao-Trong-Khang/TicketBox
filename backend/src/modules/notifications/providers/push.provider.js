...
var PushProvider = /** @class */ (function () {
    function PushProvider(dependencies) {
        this.dependencies = dependencies;
        this.name = 'push';
    }
    PushProvider.prototype.send = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dependencies.circuitBreaker.execute(function () { return __awaiter(_this, void 0, void 0, function () {
                        var messageId, title, deviceToken;
                        var _a;
                        return __generator(this, function (_b) {
                            messageId = "push_".concat((0, node_crypto_1.randomUUID)().replace(/-/g, ''));
                            title = this.buildTitle(request.type);
                            deviceToken = String((_a = request.data['deviceToken']) !== null && _a !== void 0 ? _a : '');
                            return [2 /*return*/, {
                                    messageId: messageId,
                                    channel: this.name,
                                    status: 'sent',
    ...
    PushProvider.prototype.buildTitle = function (type) {
        var _a;
        var titles = {
        ...
        return (_a = titles[type]) !== null && _a !== void 0 ? _a : "Notification: ".concat(type);
    };
    return PushProvider;
}());
