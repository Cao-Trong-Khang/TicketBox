...
var NotificationsController = function () {
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.send = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            channels = (_a = dto.channels) !== null && _a !== void 0 ? _a : this.notificationsService.listChannels();
                            this.logger.log("Received notification request: type=".concat(dto.type, ", userId=").concat(dto.userId, ", channels=").concat(channels.join(',')));
    ...
    (function () {
        ...
        _send_decorators = [(0, common_1.Post)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
