...
The repository SHALL provide a runnable frontend application foundation.
...
The repository SHALL provide a runnable NestJS backend foundation.
...
The repository SHALL provide a Docker-based local development stack.
