...
Define TicketBox authentication behavior for public registration, login, refresh-token lifecycle, logout, and current-user lookup so protected APIs can identify the caller while final authorization remains server-side.
